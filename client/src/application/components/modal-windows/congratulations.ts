...
export class CongratModalWindow extends Control {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.congratNavigation = new Control(
      this.node,
      "div",
      "navigation-congrat"
    );
    this.homeCongratBtn = new Control(
      this.congratNavigation.node,
      "button",
      "home-congrat-button",
      "Home"
    );
    this.nextCongratBtn = new Control(
      this.congratNavigation.node,
      "button",
      "next-congrat-button",
      "Next"
