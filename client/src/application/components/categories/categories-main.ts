...
export class CategoriesMain extends Control {
  ...
  constructor(parentNode: HTMLElement) {
    ...
    this.impressionism = new Control(
      this.categoriesWrapper.node,
      "div",
      "impressionism card"
    );
    ...
    this.image = new Control(
      this.impressionism.node,
      "div",
      "image-categories"
    );

    this.expressionism = new Control(
      this.categoriesWrapper.node,
      "div",
      "expressionism card"
    );
    ...
    this.score = new Control(this.heading.node, "div", "score-categories", "");
    this.image = new Control(
      this.expressionism.node,
      "div",
      "image-categories"
    );

    this.avantGarde = new Control(
      this.categoriesWrapper.node,
      "div",
      "avant-garde card"
    );
